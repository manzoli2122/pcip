<template>  
  <div>
    <section class="content-header">
      <h1>
        <span id="div-titulo-pagina">Listagem dos Usuarios </span>
        <small style="float: right;">   
            <router-link   to="/create" exact>
                        <a class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Cadastrar Usuario </a>
            </router-link>              
        </small>
      </h1>
    </section>  
          ...
          <div class="box box-success" id="div-box"> 
            <div class="box-body" style="padding-top: 5px; padding-bottom: 3px;">
              <table class="table table-bordered table-striped table-hover" id="datatable">
                <thead> 
                  <tr>
                    <th pesquisavel style="max-width:40px">ID</th>
